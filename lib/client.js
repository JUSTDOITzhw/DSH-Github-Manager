...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const CSS = `
.dsh-gm-badge{width:calc(100% + 4px);height:42px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;margin:0 -2px;padding:0 10px 0 8px;font-family:inherit;font-size:14px;display:inline-flex;overflow:hidden}
.dsh-gm-badge:hover,.dsh-gm-badge[data-active]{background:var(--dsw-alias-interactive-bg-hover)}
.dsh-gm-badgeLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}
.dsh-gm-badgeHint{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;flex:none;margin-left:auto;font-size:12px;line-height:16px}
.dsh-gm-dot{width:7px;height:7px;border-radius:50%;flex:none;background:var(--dsw-alias-label-caption)}
.dsh-gm-dot[data-on]{background:var(--dsw-alias-state-success-primary)}
.dsh-gm-layer{flex:none;align-items:center;width:100%;height:42px;margin:8px 0 0;display:flex;position:relative}
.dsh-gm-layer.dsh-gm-rail{width:36px;height:36px;margin:0}
.dsh-gm-rail .dsh-gm-badge{corner-shape:round;border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;padding:0;margin:0}
.dsh-gm-rail .dsh-gm-dot{position:absolute;top:5px;right:2px}
    ...
    function Badge(props) {
      ...
      return h("div", {
        ...
        h("button", {
          ...
          h(GitHubMark, { size: wide ? 16 : 18 }),
          wide ? h("span", { className: "dsh-gm-badgeLabel" }, "GitHub") : null,
          wide
            ? (bound
                ? h("span", { className: "dsh-gm-badgeHint" }, login === "" ? "已绑定" : `@${login}`)
                : h("span", { className: "dsh-gm-dot", "data-on": undefined }))
